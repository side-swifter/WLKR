...
///         4w , 3/8, sprocket, main sprocket, 1/4, 3 1in, main sprocket, sprocket, 2w, 3/8, 1w,       
// Constants
///

// quick functions to save my time :)
void setup(){
...
void Tuskerpid() {
  // P, I, D, and Start I
  chassis.pid_drive_constants_set(40.0, 0.0, 0.0);         // Fwd/rev constants, used for odom and non odom motions
